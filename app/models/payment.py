...
class Payment(BaseModel):
    ...
    pg_order_id = Column(String, unique=True, index=True, nullable=True)      # PhonePe: merchant_txn_id
    pg_payment_id = Column(String, unique=True, index=True, nullable=True)    # PhonePe: transactionId
    pg_signature = Column(String(255), nullable=True)                         # PhonePe S2S webhook signature
